  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <header className="flex items-center justify-between">
        ...
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#1E293B] shadow-3d-base">
          <User className="h-7 w-7 text-text-secondary" strokeWidth={2} />
        </div>
      </header>

      {/* Macro Burnout Score Card */}
      <div className="rounded-3xl bg-[#1E293B] p-6 shadow-3d-base">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-full bg-[#1E293B] px-2 py-4 text-center shadow-3d-base">
      ...
      <section>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-4 rounded-2xl bg-[#1E293B] p-4 shadow-3d-base">
